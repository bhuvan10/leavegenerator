const { degrees, PDFDocument, rgb, StandardFonts } = PDFLib
    ...
    var wardens = ['Krishna M', 'Arun Kumar Jalan', 'Nitin Chaturvedi', 'Krishnendra Shekhawat', 'Rakhee', 'Kumar Sankar Bhattacharya', 'Praveen Kumar A.V.', 'Dipendu Bhunia', 'Sharad Shrivastava','Sharad Shrivastava','Sharad Shrivastava']
    var hostels = ['Srinivasa Ramanujan Bhawan', 'Krishna Bhawan', 'Gandhi Bhawan', 'Vishwakarma Bhawan', 'Meera Bhawan', 'Shankar Bhawan', 'Vyas Bhawan', 'Ram Bhawan', 'Budh Bhawan','Ashok Bhawan','RanaPratap Bhawan']
